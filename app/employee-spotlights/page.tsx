    ...
    <main className="page-shell">
      ...
      <section className="section section--split">
        <div className="section__copy">
          ...
          <p>
            Audrey Montgomery's page should say this plainly: NASA needs people
            who can organize complexity, protect public trust, negotiate
            responsibly, and keep giant programs aligned with mission reality.
          </p>
          <p>
